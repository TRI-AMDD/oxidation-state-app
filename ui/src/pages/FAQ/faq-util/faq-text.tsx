...
export const FAQ_ITEMS: FAQText[] = [
    ...
    },
    {
        ...
        answer: `We plan on releasing the software library used to evaluate oxidation states soon. A description of this library and installation instructions can be found <a rel='noopener noreferrer' target='_blank' href='${GITHUB_LINK}'>here</a>. API documentation is generated when the library is installed, and it can also be found <a rel='noopener noreferrer' target='_blank' href='https://javadoc.oxi.matr.io/'>online</a>.`
    },
    {
        question: 'Is there an API for the online application?',
        answer: `Yes. Documentation can be found <a rel='noopener noreferrer' target='_blank' href='https://oxi.matr.io/api_swagger'>here</a>. This API can be used to automate the analysis of oxidation states without installing the Java library. The returned JSON files have the same structure as the PageData class in the <a rel='noopener noreferrer' target='_blank' href='${GITHUB_LINK}'>Java library</a> (see <a rel='noopener noreferrer' target='_blank' href='https://javadoc.oxi.matr.io/'>Javadoc</a> for details).`
    },
    {
